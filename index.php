...
header("Content-type: text/javascript");
		...
		$url.="&rentzestimate=true";
            ...
            if($xml->response->results->result->zestimate->valuationRange->low!="")
             ...
             if($xml->response->results->result->zestimate->valuationRange->high!="")
			     $estimateValuationRangeHigh = (string)" $". number_format(doubleval($xml->response->results->result->zestimate->valuationRange->high),2);
			else 
    ...
    $arr = array(   'homeDetails' => $homeDetails,
                ...
                $zpid = (string)$xml->response[0]->results[0]->result[0]->zpid;
                        $zwsid = "X1-ZWz1b2xb3nng97_82rpe";
